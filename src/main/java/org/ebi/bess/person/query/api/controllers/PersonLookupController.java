package org.ebi.bess.person.query.api.controllers;
...
@RestController
@RequestMapping(path = "/api/v1/personLookup")
public class PersonLookupController {
    private final QueryGateway queryGateway;

    @Autowired
    public PersonLookupController(QueryGateway queryGateway) {
    ...
    public ResponseEntity<UserLookupResponse> getAllUsers() {
        try {
            ...
            var safeErrorMessage = "Failed to complete get all person request";
